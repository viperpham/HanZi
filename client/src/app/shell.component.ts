...
/**
 * Layout đã đăng nhập: sidebar + topbar + nội dung trang.
 * Render qua route layout (children của path '') — KHÔNG hoán đổi router-outlet
 * bằng @if nữa (nguyên nhân màn login "dính" lại sau khi đăng nhập).
 */
@Component({
  selector: 'app-shell',
  standalone: true,
